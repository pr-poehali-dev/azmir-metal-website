        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl">
            ...
            <p className="text-xl text-slate-300 mb-10 max-w-2xl">
              Производство из нержавеющей стали для пищевой промышленности. 
              Резервуары, емкости, технологические линии. Качество ручной аргонной сварки.
            </p>
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <Button 
                ...
                className="bg-gradient-to-r from-primary via-cyan-600 to-teal-600 hover:from-primary/90 hover:via-cyan-600/90 hover:to-teal-600/90 text-white border-0 text-lg px-8 shadow-xl"
              >
                Наши проекты
              </Button>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Оборудование из нержавеющей стали для пищевой промышленности и не только
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              {
                title: 'Резервуары из нержавейки',
                description: 'Емкости для пищевой промышленности из AISI 304/316. Соответствие санитарным нормам.',
                icon: 'Container',
                image: 'https://cdn.poehali.dev/projects/0c2644c8-3d1e-43a8-bdfb-9e74c7a9a10f/files/9d2e5155-f5d1-4c65-b0f0-94d2500dc6cc.jpg'
              },
              {
                title: 'Оборудование для пищепрома',
                description: 'Технологические линии, баки, емкости. Аргонная сварка нержавеющей стали.',
                icon: 'Factory',
              ...
              },
              {
                ...
                description: 'Нестандартные конструкции по вашим чертежам. Любая сложность.',
                icon: 'Wrench',
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-slate-300 max-w-3xl mx-auto">
              Специализируемся на оборудовании из нержавеющей стали для пищевой промышленности. 
              Аргонная сварка, герметичность швов, соответствие санитарным нормам.
            </p>
          </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-slate-300">
                    Профессиональная аргонодуговая сварка AISI 304/316. 
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-muted-foreground mb-6">
                Алтайский завод металлоизделий и резервуаров — производитель оборудования 
                из нержавеющей стали для пищевой и перерабатывающей промышленности.
              </p>
              <p className="text-lg text-muted-foreground mb-6">
                Изготавливаем резервуары, емкости, технологические линии из нержавейки AISI 304/316. 
                Применяем аргонодуговую сварку для герметичности и соответствия санитарным нормам. 
                Работаем с типовыми и индивидуальными проектами.
              </p>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              { title: 'Резервуары AISI 304 для маслозавода', category: 'Производство масел', image: 'https://cdn.poehali.dev/projects/0c2644c8-3d1e-43a8-bdfb-9e74c7a9a10f/files/0722f825-272f-4f02-a6a7-8057eb67c5df.jpg' },
              { title: 'Технологические емкости для мясокомбината', category: 'Мясная промышленность', image: 'https://cdn.poehali.dev/projects/0c2644c8-3d1e-43a8-bdfb-9e74c7a9a10f/files/6f78ee9f-56c6-478a-b067-4498afa0f6d8.jpg' },
            ].map((project, idx) => (
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li><a href="#" className="hover:text-primary transition-colors">Оборудование для пищепрома</a></li>
